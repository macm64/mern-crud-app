...
/******/ 	__webpack_require__.p = "/home/miguelc/Proyectos/mern-crud-app/public";
/******/
/******/
...
var _ContactsList = __webpack_require__(/*! ./ContactsList */ "./app/components/ContactsList.js");
...
var App = function (_Component) {
  ...
  function App(props) {
    ...
    _this.editStates = _this.editStates.bind(_this);
    return _this;
  }

  _createClass(App, [{
    key: 'editStates',
    value: function editStates(data) {
      this.setState({
        _id: data._id,
        name: data.name,
    ...
    value: function fetchContacts() {
      ...
      fetch('/api/contact/').then(function (res) {
        ...
        _this3.setState({ contacts: data });
        console.log(_this3.state.contacts);
      });
    }
  }, {
    key: 'handleChange',
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
                  ...
                  _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                      ...
                      _react2.default.createElement(
                        ...
                        _react2.default.createElement('input', { name: 'name', type: 'text', onChange: this.handleChange, value: this.state.name, placeholder: 'First Name' })
                      )
                    ),
                    _react2.default.createElement(
                      'div',
                      ...
                      _react2.default.createElement(
                        'div',
                        { className: 'input-field col s12' },
                        _react2.default.createElement('input', { name: 'lastName', type: 'text', onChange: this.handleChange, value: this.state.lastName, placeholder: 'Last Name' })
                      )
                    ),
                    _react2.default.createElement(
                      'div',
                      ...
                      _react2.default.createElement(
                        'div',
                        { className: 'input-field col s12' },
                        _react2.default.createElement('input', { name: 'email', type: 'text', onChange: this.handleChange, value: this.state.email, placeholder: 'Email' })
                      )
                    ),
                    _react2.default.createElement(
                      'div',
                      ...
                      _react2.default.createElement(
                        'div',
                        { className: 'input-field col s12' },
                        _react2.default.createElement('input', { name: 'contactNumber', type: 'text', onChange: this.handleChange, value: this.state.contactNumber, placeholder: 'Contact Number' })
                      )
                    ),
                    _react2.default.createElement(
                      'div',
                      ...
                      _react2.default.createElement(
                        'div',
                        { className: 'input-field col s12' },
                        _react2.default.createElement('input', { name: 'age', type: 'text', onChange: this.handleChange, value: this.state.age, placeholder: 'Age' })
                      )
                    ),
                    _react2.default.createElement(
                      'button',
                      { type: 'submit', className: 'btn light-blue darken-4' },
            ...
            _react2.default.createElement(_ContactsList2.default, { contacts: this.state.contacts, fetchContacts: this.fetchContacts, editStates: this.editStates })
          )
        )
      );
    }
...
var ContactsList = function (_Component) {
  ...
  function ContactsList(props) {
    ...
    _this.drawTable = _this.drawTable.bind(_this);
    return _this;
  }
  ...
  _createClass(ContactsList, [{
    ...
    key: 'drawTable',
    value: function drawTable(contacts) {
      var _this3 = this;
              ...
              _react2.default.createElement(
                ...
                _react2.default.createElement(
                  ...
                  { onClick: function onClick() {
                      return _this3.editContact(contact._id);
                ...
                _react2.default.createElement(
                  'button',
                  { className: 'btn light-blue darken-4', onClick: function onClick() {
                      return _this3.deleteContact(contact._id);
                    } },
                  _react2.default.createElement(
                    'i',
                    { className: 'material-icons' },
...
module.exports = __webpack_require__(/*! /home/miguelc/Proyectos/mern-crud-app/src/app/index.js */"./app/index.js");
